...
public class findFrame extends JFrame implements ActionListener, TableModelListener {
	...
	findFrame() throws Exception {
		...
		slangW = readFile.getInstance();
		// Title Label
		JLabel titleLabel = new JLabel();
		titleLabel.setText("Tìm Kiếm");
		...
		titleLabel1.setText("Nhập slang word bạn muốn tìm kiếm ");
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnFind) {
			...
			int n = JOptionPane.showOptionDialog(this, "Chọn chế độ bạn muốn tìm kiếm ", "Chế độ tìm",
